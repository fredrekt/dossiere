...
const Landing = ({introSection}) => {

    useEffect(()=>{
        scrollToComponent(introSection, { offset: 0, align: 'top', duration: 2000, ease:'inSine'})
    },[])
    ...
    return (
        <>
            ...
            <section ref={(section) => { introSection = section}}>
                    ...
                    <MDBCol md="4">
                        <MDBContainer style={containerStyle}>
                            ...
                            <h5 className="h5-responsive mb-4">
                                Our landing page works on all devices, so you only have to set 
                            ...
                            <Link className="link-landing-custom" to="/login">
            ...
            <div style={{ position: 'relative', marginTop: '15%', marginBottom: '-10%' }}>
                ...
                <div style={{ position: 'absolute', color: "#fff", marginBottom: '3%', left: 0, right: 0, bottom: 0, fontWeight: '900' }} className="text-center">
                    Copyright {copyrightDate} | <a className="white-text" href="https://www.facebook.com/fredgaringo">Fred Garingo</a>
                </div>
            </div>
        </>
    )
